    ...
    <div className={styles.home}>
      ...
      <section className={styles.heroPlate}>
        <div className={styles.heroPlateBg}>
          <div className="panel">
            <Image src="/images/hero/lineup-1.png" alt="Royal blue hi-vis conti suit" fill sizes="20vw" priority style={{ objectFit: 'cover', objectPosition: 'bottom center' }} />
          </div>
          <div className="panel">
            <Image src="/images/hero/lineup-2.png" alt="Branded corporate shirt" fill sizes="20vw" priority style={{ objectFit: 'cover', objectPosition: 'bottom center' }} />
          </div>
          <div className="panel">
            <Image src="/images/hero/lineup-3.png" alt="Yellow cotton tee" fill sizes="20vw" priority style={{ objectFit: 'cover', objectPosition: 'bottom center' }} />
          </div>
          <div className="panel">
            <Image src="/images/hero/lineup-4.png" alt="Pink striped corporate polo" fill sizes="20vw" priority style={{ objectFit: 'cover', objectPosition: 'bottom center' }} />
          </div>
          <div className="panel">
            <Image src="/images/hero/lineup-5.png" alt="Black hi-vis rain jacket" fill sizes="20vw" priority style={{ objectFit: 'cover', objectPosition: 'bottom center' }} />
          </div>
        </div>
